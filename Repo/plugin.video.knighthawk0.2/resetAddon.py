...
def resetAddon():
    ...
    d = xbmcgui.Dialog()
    d.ok('[COLOR blue][B]AMO[/B][/COLOR][COLOR green]box[/COLOR]', 'Community builds addon_data now removed.', 'Your locally stored builds will be unaffected but your', 'settings have now reset back to the defaults.')
